...
public class IceCreamCone {
   ...
   *@return int - rep. number of ice cream cones 
   */
   public static int getCount() { 
      return count; 
   }
   /**This method will reset the count variable.  
   */
   public static void resetCount() {
      count = 0; 
   }
   /**This method will return whether the input
   *is type IceCreamCone.
   *@param obj - object of unspecifed class 
   *@return boolean - true if obj is IceCreamCone 
   *otherwise false 
   */
